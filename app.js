...
const PRODUCTS = [
  ...
  { id: 22, name: 'Choco Chips Cake', cat: 'chocolate', desc: 'Moist cake loaded with choco chips', img: 'gallery/Choco Chips Cake.webp', prices: [{ label: '500gm', val: 400 }, { label: '1kg', val: 800 }] },
